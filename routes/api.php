...
Route::group([
    ...
    Route::group([
      'middleware' => 'auth:api'
        ...
        Route::post('/agregarFavorito/{producto}', [FavoritoApiController::class, 'agregarFavorito']);
        Route::post('/eliminarFavorito/{producto}', [FavoritoApiController::class, 'eliminarFavorito']);
    });
});
